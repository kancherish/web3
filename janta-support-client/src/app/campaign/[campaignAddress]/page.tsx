...
export default function CampaignPage() {
    ...
    // Get Campaign Name
    const { data: campaignName, isPending: isPendingNamne } = useReadContract({
        contract,
    ...
    const { data: campaignDescription, isPending: isPendingDesc } = useReadContract({
        contract,
        method: "function desc() view returns (string)",
        params: []
    });
    ...
    const { data: tiers, isPending: isPendingTiers } = useReadContract({
        contract,
        method: "function getTiers() view returns ((string name, uint256 amt, uint256 backers)[])",
        params: []
    });
    ...
    const { data: status, isPending: isStatusPening } = useReadContract({
        contract,
                ...
                {owner === account?.address && (
                    <div className="flex flex-row gap-2">
                        ...
                        <TransactionButton
                            ...
                            onTransactionConfirmed={async () => alert("witdraw successfully!")}
                            style={{
                                marginTop: "1rem",
            ...
            <div className="w-1/2 bg-slate-100 p-6 rounded-md">
                ...
                <div className="flex flex-col">
                    ...
                    <TransactionButton
                        transaction={() => prepareContractCall({
                            contract,
                            method: "function addTier(string _name, uint256 _amt)",
